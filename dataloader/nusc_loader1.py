...
class NuScenesLoader(Dataset):
    ...
    def __init__(self, 
                 scene_token_list='./list/nusc/official_train_scene.txt', 
...
class NuScenesLoader1(Dataset):

    def __init__(self, 
                 scene_token_list='./list/nusc/official_val_scene.txt', 
                 data_root='/datasets/nuscenes/v1.0-trainval',
                 cam_channels=['CAM_FRONT'],
                 size=(350, 800)):
        super(NuScenesLoader1, self).__init__()
